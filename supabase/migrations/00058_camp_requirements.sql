ALTER TABLE public.camps
    ADD COLUMN camp_requirements JSONB NOT NULL DEFAULT '[]'::jsonb,
    ADD CONSTRAINT camps_requirements_array_ck CHECK (jsonb_typeof(camp_requirements) = 'array');

CREATE OR REPLACE FUNCTION public.save_camp_offer(
    p_camp_id UUID,
    p_metadata JSONB,
    p_club_id UUID,
    p_coach_id UUID,
