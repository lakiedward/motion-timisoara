  ...
  return (
    <article className="container mx-auto max-w-3xl space-y-6 px-4 py-12">
      <h1 className="font-display text-3xl font-bold">
        Confidențialitate și locație în timpul ședințelor
      </h1>
      ...
      <section className="space-y-3">
        ...
        <p>
          Antrenorul poate porni explicit partajarea poziției telefonului său pentru o ședință.
          Funcția nu urmărește telefoanele copiilor și nu creează un istoric al deplasărilor lor. Se
          transmite periodic doar cea mai recentă poziție, precizia GPS și ora capturării.
        </p>
        <p>
      ...
      <section className="space-y-3">
        ...
        <p>
          Partajarea se încheie cel târziu la sfârșitul ședinței plus 15 minute. Oprirea șterge
          poziția din datele active ale aplicației. La expirare, accesul este refuzat imediat, iar
          curățarea programată șterge rândurile la următoarea rulare reușită, programată în fiecare
          minut.
        </p>
        <p>
          ...
          cererilor repetate sunt păstrați până la încheierea intervalului ședinței. Copiile de
          siguranță și jurnalele tehnice ale infrastructurii au propriile reguli de retenție;
          ștergerea din aplicație nu înseamnă ștergere instantanee din aceste copii.
        </p>
      </section>
      <section className="space-y-3">
